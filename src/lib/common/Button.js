...
const Button = styled.button.attrs(props => ({
    ...
    border: 1px solid ${interpretTheme('prm')};
    border-radius: 6px;
    font-size: 0.8em;
    font-weight: lighter;
    color: ${interpretTheme('prm')};
    ...
    &:hover {
        border: 1px solid ${interpretTheme('prmDk')};
        color: ${interpretTheme('prmDk')};
    ...
    ${props => props.important && css`
        background: ${interpretTheme('prm')};
        color: white;

        &:hover {
            background: ${interpretTheme('prmDk')};
            color: white;
        }
    `}
